...
import { FileText, Calendar, User, Pill, Clock, CheckCircle, XCircle, Plus, Search } from 'lucide-react';
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage all your patient prescriptions</p>
            </div>
            <Link
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-1 text-sm text-gray-500">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>{prescription.patient?.name || 'Unknown Patient'}</span>
                        </div>
                        <div className="flex items-center space-x-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="text-sm text-gray-700">
                      <p><strong>Name:</strong> {prescription.patient?.name || 'Unknown'}</p>
                      <p><strong>Age:</strong> {prescription.patient?.age || 'N/A'}</p>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-700">
                      ...
                      <p><strong>Duration:</strong> {prescription.duration || 'Not specified'}</p>
                      <p><strong>Total Medicines:</strong> {prescription.medicines.length}</p>
                    </div>
                  </div>
                </div>
