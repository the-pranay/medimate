    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your practice preferences and professional settings</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Professional Settings</h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Automatically confirm appointments after payment</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    className="sr-only peer"
                    checked={settings.professional.autoConfirmAppointments}
                    onChange={(e) => handleSettingChange('professional', 'autoConfirmAppointments', e.target.checked)}
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                </label>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900">Buffer Time (minutes)</h3>
                  <p className="text-sm text-gray-500">Time between appointments for preparation</p>
                </div>
                <select
                  value={settings.professional.bufferTime}
                  onChange={(e) => handleSettingChange('professional', 'bufferTime', parseInt(e.target.value))}
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900">Max Daily Appointments</h3>
                  <p className="text-sm text-gray-500">Maximum number of appointments per day</p>
                </div>
                <select
                  value={settings.professional.maxDailyAppointments}
                  onChange={(e) => handleSettingChange('professional', 'maxDailyAppointments', parseInt(e.target.value))}
                  className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900">Allow Direct Booking</h3>
                  <p className="text-sm text-gray-500">Allow patients to book appointments directly</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
